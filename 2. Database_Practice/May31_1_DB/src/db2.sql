...
insert into enrollment values(1, 103, date '2024-06-01');
...
drop table enrollment cascade constraint purage;
drop table course cascade constraint purage;
drop table professor cascade constraint purage;
drop table student cascade constraint purage;
