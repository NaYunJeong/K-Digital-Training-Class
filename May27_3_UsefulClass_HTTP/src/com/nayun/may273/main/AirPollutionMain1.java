...
// 사이트 - '미세먼지' 검색 - 하단 서울시 권역별 실시간 대기환경 현황 - open ai - open AI - 샘플 URL
...
// Parsing - kxml2.jar				// 파일 가져오기 - mvnrepository 검색
//	필요없는 데이터는 걷어내고, 원하는 형태로 가공하는 작업

// [kxml2.jar] 파일 가져오기 - mvnrepository 검색
// https://mvnrepository.com/
// kxml 검색 - 첫번째 - Central - 2.3.0 - jar 파일 다운

// 서울URL : http://openapi.seoul.go.kr:8088/sample/xml/RealtimeCityAir/1/5/   //(1/5 -> 1번~5번 // 우리는 끝까지 볼거야 => 1/25)  
// => http://openapi.seoul.go.kr:8088/4f626857416f6c6c3632586a416843/xml/RealtimeCityAir/1/25/   //(1/5 -> 1번~5번 // 우리는 끝까지 볼거야 => 1/25)  
// 인증키  : 4f626857416f6c6c3632586a416843    // 위에 sample 자리에 붙여넣기
