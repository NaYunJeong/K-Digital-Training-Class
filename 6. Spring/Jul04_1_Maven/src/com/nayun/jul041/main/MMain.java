package com.nayun.jul041.main;

import com.nayun.http.client.NayunHttpClient;

// Java는 전 세계적으로 많이 사용하고있는 언어
//		개발자들이 본인이 만들어 놓은 것들을 공유 !
//		소스 자체를 공유 X, .jar파일 만들어서 기능만 공유하는 문화 O
...
//		우리가 만든 보물들 => dbmanager, httpclient, ... 

// 프로젝트 우클릭 - configure - convert to Maven => pom.xml 생성됨

//////////////////////////////////////////////////////////////////

// Maven 새로고침
// Window - show view - other - 'maven' 검색 -
// Maven Repositories - Local Repositories 우클릭 => rebuild index
...
// *오늘부터 이클립스 재시동할 때 꼭 해야하는 것* (DB연동 이후)
// (이클립스 켜기 전)
