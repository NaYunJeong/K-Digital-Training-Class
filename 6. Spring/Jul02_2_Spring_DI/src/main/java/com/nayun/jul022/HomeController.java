...
import com.nayun.jul022.book.Book;
import com.nayun.jul022.dog.Dog;
...
public class HomeController {
	...
	// 의존성 주입(Dependency Injection)는 제어의 역전 패턴을 달성하는 방법 중 하나
...
//		System.out.println(d.getAge());
		...
		// 책 객체를 만들어서 이름-가격 출력
		Book book = aac.getBean("book", Book.class);
		System.out.println(book.getName());
		System.out.println(book.getPrice());
		System.out.println("--------------------");
		
		Book book2 = aac.getBean("book2", Book.class);
		System.out.println(book2.getName());
		System.out.println(book2.getPrice());
		System.out.println("--------------------");
		
		Book book3 = aac.getBean("book3", Book.class);
