...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		//		- 코드 작성 문법 에로를 체크하도록 정보를 제공
		//		- 이 개발 툴이 코드를 자동으로 생성할 수 있도록 도와줌 (V, 주로)
		//		- 실행시에 특정한 기능을 수행하도록 도와줌 (V, 주로)
		
		// 종류 (2,3,5,6,8번은 잘 알아두기!)
